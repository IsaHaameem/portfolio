      ...
      <div className="max-w-4xl mx-auto flex flex-col items-start">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <Link href="https://github.com/IsaHaameem" target="_blank" className="p-3 bg-surface border border-border rounded-xl text-muted hover:text-white transition-colors">
              <FiGithub size={22} />
            </Link>
            <Link href="https://www.linkedin.com/in/muhammad-isa-haameem-ba420834a" target="_blank" className="p-3 bg-surface border border-border rounded-xl text-muted hover:text-white transition-colors">
              <FiLinkedin size={22} />
            </Link>
          </div>
        </motion.div>
